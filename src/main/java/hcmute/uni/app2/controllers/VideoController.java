...
import hcmute.uni.app2.services.impl.CategoryServiceImpl;
import hcmute.uni.app2.services.impl.VideoServiceImpl;
import hcmute.uni.app2.dao.ICategoryDao;
import hcmute.uni.app2.dao.impl.CategoryDaoImpl;
...
{
    private final IVideoService videoService = (IVideoService) new VideoServiceImpl();
    private final ICategoryDao categoryDao = new CategoryDaoImpl();
    private final ICategoryService categoryService = new CategoryServiceImpl(categoryDao);
